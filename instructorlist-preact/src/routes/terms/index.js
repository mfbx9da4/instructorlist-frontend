...
export default () => (
  <>
    <h2>
      Terms of Service of <span class="website_url">instructorlist.org</span>
    </h2>

    <p>
      <span class="website_name">Instructorlist</span> ("Us" or "We") provides
      the <span class="website_url">instructorlist.org</span> website and
      various related services (collectively, the "Website") to you, the User,
      subject to your compliance with all the terms, conditions, and notices
      contained or referenced herein (the "Terms of Service"), as well as any
    ...
    <p>
      ...
      to abide and be bound by the modified Terms of Service. This Terms of
    ...
    <p>
      ...
      or through this Website. However, we and our agents have the right at
      their sole discretion to remove any content that, in our judgment, does
      not comply with these Terms of Service and any other rules of user conduct
      for our site, or is otherwise harmful, objectionable, or inaccurate. We
      are not responsible for any failure or delay in removing such content. You
    ...
    <p>
      ...
      copyright of <span class="website_name">Instructorlist</span> or its
      ...
      <span class="website_name">Instructorlist</span> or its Affiliates.
    </p>
    ...
    <p>
      ...
      <span class="website_name">Instructorlist</span> spokesperson speaking in
    ...
    <p>
      ...
      bar any further access to such files or this Website. We shall not be
      liable to you or any third party for any claims or damages arising out of
    ...
    <p>
      ...
      internal laws of the <span class="country">gb</span> without giving effect
    ...
    <p>
      ...
      federal courts of <span class="country">gb</span>.
    </p>
  </>
)
