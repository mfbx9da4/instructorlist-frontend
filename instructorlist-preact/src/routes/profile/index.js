...
export default () => {
  return (
    <div>
      ...
      <p>
        Instructorlist built the Instructorlist app as a commercial app. This
        SERVICE is provided by Instructorlist at no cost and is intended for use
        as is.
      </p>
      ...
      <p>
        ...
        Terms and Conditions, which is accessible at Instructorlist, unless
      ...
      <p>
        ...
        but not limited to users name, address, location and pictures. The
      ...
      <p>
        &gt;!-- Check if this is true for your app, if unsure, just assume that
        you do use cookies and modify this next line --&gt;This Services does
        not uses these “cookies” explicitly. However, the app may use third
        party code and libraries that use “cookies” to collection information
        and to improve their services. You have the option to either accept or
